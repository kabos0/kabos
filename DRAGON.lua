...
io.write('\27[0;31m\n ارسل لي توكن البوت الان •═════•| • ᴠᴏʟᴛᴀʀ • |•═════• :\na•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي •═════•| • ᴠᴏʟᴛᴀʀ • |•═════• :\na•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•\n\27[0;33;49m')
...
io.write('\27[1;31m •═════•| • ᴠᴏʟᴛᴀʀ • |•═════• ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
token = sudos.token 
--- start functions •═════•| • ᴠᴏʟᴛᴀʀ • |•═════•
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/kabos0/Kabos/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1816324532,1918870568,2060947106}   
...
var = 'مبرمج السورس'
elseif tonumber(user_id) == tonumber(1946447575) then
var = 'الـكـابـوس صـاحـب الـسـورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "المطور الثانوي"  
...
local V_O_L_T_E_R = database:get(bot_id..'text:ch:user')
if V_O_L_T_E_R then
send(msg.chat_id_, msg.id_,'['..V_O_L_T_E_R..']')
else
...
os.execute('wget https://raw.githubusercontent.com/kabos0/Kabos/main/DRAGON.lua')
...
local Text = '◉ انت الان المطور الاساسي في البوت \n◉ يمكنك تحكم في البوتات من الكيبورد قم بأختيار ماتريده من الازار في الاسفل↑↓\n[تابع جديدنا](t.me/V_O_L_T_E_R)'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/dv_harlin/404&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_H_J/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'ѕᴏᴜʀᴄѕ ᴠᴏʟᴛᴀʀ' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس فولتر ادخل وتابع الجديد](t.me/V_O_L_T_E_R)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/V_O_L_T_E_R"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ᴅᴠ ᴇʟᴋᴀʙᴏѕ',url="t.me/X_U_B"},{text = 'ᴅᴠ ᴊᴀᴍᴍᴀᴍ', url="t.me/A_2_2"}},
{{text = 'ѕᴏᴜʀᴄѕ ᴠᴏʟᴛᴀʀ', url="t.me/V_O_L_T_E_R"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/dv_harlin/404&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_V_X/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'عبدالله' or text == 'الكابوس' or text == 'كابوس' or text == 'مبرمج السورس' then
local Text = [[
الكابوس مبرمج سورس فولتر لوحابب تتواصل معاه ❤️.

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᴅᴠ ᴇʟᴋᴀʙᴏѕ',url="t.me/X_U_B"}},
{{text = 'ѕᴏᴜʀᴄѕ ᴠᴏʟᴛᴀʀ', url="t.me/V_O_L_T_E_R"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/X_U_B&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'محمد' or text == 'محمد الهقر' or text == 'الهقر' or text == 'الكابوس بتع طنطا' then
local Text = [[
الكابوس مبرمج سورس فولتر لوحابب تتواصل معاه ❤️.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᴅᴠ ᴇʟᴋᴀʙᴏѕ',url="t.me/G_W_P"}},
{{text = 'ѕᴏᴜʀᴄѕ ᴠᴏʟᴛᴀʀ', url="t.me/V_O_L_T_E_R"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'جمام' or text == 'جمام الهقر' or text == 'جمام الهكر' or text == 'مطور السورس' then
local Text = [[
جمام مبرمج سورس فولتر لوحابب تتواصل معاه ❤️.
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/A_2_2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_V_X/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[  
•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•
 اهلا في قائمه الالعاب المتطوره سورس فولتر
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/O_V_X/65&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《 مـــطـــور الـبـــوت 》](t.me/V_O_L_T_E_R)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ تم تعطيل جلب الصوره ،\n ◉ تم قفل البوتات  ،\n ◉ تم قفل التكرار ،\n ◉ تم قفل الروابط ،\n ◉ تم قفل التوجيه ،\n ◉ تم قفل الملصقات ،\n ◉ تم قفل المتحركه ،\n ◉ تم قفل الفيديو ،\n ◉ تم قفل الفشار ،\n ◉ تم قفل الانلاين ،\n ◉ تم قفل تعديل المديا ،\n ◉ تم وضع التكرار  ،\n ◉ تم قفل الفارسيه  ،\n ◉ تم وضع الايدي بدون صوره ،\n ◉ تم تفعيل الحمايه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'V_O_L_T_E_R')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'V_O_L_T_E_R')..')  ')
end,nil)   
end
if text == 'قفل الدردشه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id.."lock:text"..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◉  من قبل  ⇇[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'V_O_L_T_E_R')..') \n ◉ تم قفل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉  من قبل  ⇇['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'V_O_L_T_E_R')..') \n ◉ تم قفل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1816324532) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1816324532) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(2060947106) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ◉ العضو   ⇇['..result.title_..'](t.me/'..(username or 'V_O_L_T_E_R')..')'
...
if tonumber(userid) == tonumber(2060947106) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1816324532) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/kabos0/Kabos/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◉ اهلا بك في متجر ملفات فولتر\n ◉ ملفات السورس •═════•| • ᴠᴏʟᴛᴀʀ • |•═════•\n•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•\n"
local TextE = "\n•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•\n ◉ علامة تعني { ✔️ } ملف مفعل\n ◉ علامة تعني { ✖ } ملف معطل\n ◉ قناة سورس فولتر•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•\n".." ◉ [اضغط هنا لدخول](t.me/V_O_L_T_E_R) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/kabos0/Kabos/main/File_Bot/"..file)
if res == 200 then
...
if text == ("مسح قائمه فولتر") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه فولتر')
return false
end

if text == 'قائمه فولتر' and Sudo(msg) then
...
if text == ("رفع فولتر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local V_O_L_T_E_R = database:get(bot_id..'text:ch:user')
if V_O_L_T_E_R then
send(msg.chat_id_, msg.id_,'['..V_O_L_T_E_R..']')
...
if text and text:match("^رفع فولتر@(.*)$") and Sudo(msg) then
local username = text:match("^رفع فولتر@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local V_O_L_T_E_R = database:get(bot_id..'text:ch:user')
if V_O_L_T_E_R then
send(msg.chat_id_, msg.id_,'['..V_O_L_T_E_R..']')
...
if text and text:match("^رفع فولتر(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع فولتر(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local V_O_L_T_E_R = database:get(bot_id..'text:ch:user')
if V_O_L_T_E_R then
send(msg.chat_id_, msg.id_,'['..V_O_L_T_E_R..']')
...
if text == ("تنزيل فولتر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local V_O_L_T_E_R = database:get(bot_id..'text:ch:user')
if V_O_L_T_E_R then
send(msg.chat_id_, msg.id_,'['..V_O_L_T_E_R..']')
...
if text and text:match("^تنزيل فولتر@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل فولتر@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local V_O_L_T_E_R = database:get(bot_id..'text:ch:user')
if V_O_L_T_E_R then
send(msg.chat_id_, msg.id_,'['..V_O_L_T_E_R..']')
...
if text and text:match("^تنزيل فولتر(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل فولتر(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local V_O_L_T_E_R = database:get(bot_id..'text:ch:user')
if V_O_L_T_E_R then
send(msg.chat_id_, msg.id_,'['..V_O_L_T_E_R..']')
...
t = "\n ◉ قائمه زوجات الجروب \n ◉═───═❲[ѕᴏᴜʀᴄѕ ᴠᴏʟᴛᴀʀ](t.me/V_O_L_T_E_R)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
' }\n'..' ◉  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ◉  الرفع  ⇇{ '..setadd..
' }\n'..' ◉  الحظر  ⇇{ '..banm..' }\n\n ◉═───═❲[ѕᴏᴜʀᴄѕ ᴠᴏʟᴛᴀʀ](t.me/V_O_L_T_E_R)❳═───═ ◉\n ◉ قناة سورس فولتر•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•\n [ ❲[ѕᴏᴜʀᴄѕ ᴠᴏʟᴛᴀʀ](t.me/V_O_L_T_E_R)❳](t.me/V_O_L_T_E_R) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•\nاضغط علي الاسم ليتم نسخه\n•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•ٴ\n ◉ [ѕᴏᴜʀᴄѕ ᴠᴏʟᴛᴀʀ](t.me/V_O_L_T_E_R)◉ ')
end
...
end --الكود حصري سورس فولتريعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فولتر').." غادر" or text == 'غادر' then  
...
local msg_id = msg.id_/2097152/0.5  
local textt = 'انت مجرد ادمن اجتهد عشان ياخد رتبه😹❤️'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = 'انت مميز ابن ناس 😊❤️'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔](t.me/V_O_L_T_E_R)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..🤭❤](t.me/V_O_L_T_E_R)')
return false
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..🙂❤](t.me/V_O_L_T_E_R)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🥺♥️](t.me/V_O_L_T_E_R)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/V_O_L_T_E_R)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/V_O_L_T_E_R)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بعشقق يواد.🥰❤️](t.me/V_O_L_T_E_R)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🙂❤](t.me/V_O_L_T_E_R)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/V_O_L_T_E_R)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..🥺💕](t.me/V_O_L_T_E_R)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻❤](t.me/V_O_L_T_E_R)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹❤](t.me/V_O_L_T_E_R)')
return false
end
end
end
...
[[
↑•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ◉  
↑•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•𝙄𝘿 ➱ #id
↑•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•𝙍𝘼𝙉𝙆 ➱  #stast ◉  
↑•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•𝙈𝘼𝙎𝙂 ➱ #msgs ◉  
↑•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•𝗖𝗛 ➯  ↝@V_O_L_T_E_R↜ ◉  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
𝟓 𝟔 𖡻 #msgs  ࿇🦄
...
local Text = [[
•═════•| • ᴠᴏʟᴛᴀʀ • |•═════•
🎮 اهلا بك في قسم الالعاب بسورس فولتر ⇊
...
keyboard.inline_keyboard = {
{
{text = 'العاب السورس', callback_data="/mute-name"},{text = 'العاب فولتر', callback_data="/change-photo"},
},
{
