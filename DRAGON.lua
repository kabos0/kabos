...
sudo_users = {SUDO,1816324532,1618966805,1932226438}   
...
if tonumber(result.sender_user_id_) == tonumber(1618966805) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1618966805) then
...
if tonumber(userid) == tonumber(1618966805) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
{{text = 'نسبه جمالي', callback_data="/help18"},{text = 'اليتيوب', callback_data="/help24"}},
{{text = 'القائمه الرائسيه', callback_data="/add"}},
{{text = '𝐬𝐨𝐮𝐫𝐜𝐞 𝐫𝐨𝐨𝐠??𝐧', url="t.me/V_O_L_T_E_R"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if Text == '/help12' then
